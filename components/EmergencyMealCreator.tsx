...
import { generateEmergencyRecipes, GeneratedRecipe, RecipeGenerationResponse } from '../lib/gemini-service';
      ...
      <div className="max-w-6xl mx-auto">
        <header className="text-center mb-8">
          ...
          <p className="text-gray-600 mb-4">
            Powered by Google Gemini AI - Enter your ingredients and get creative recipes!
          </p>
        </header>
        ...
        <footer className="text-center mt-8 text-gray-500">
          <p>Powered by Google Gemini AI • Create amazing meals from whatever you have at home!</p>
        </footer>
      </div>
    </div>
  );
